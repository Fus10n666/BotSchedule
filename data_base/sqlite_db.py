...
#Просмотр новостей со стороны пользователя
async def get_news():
    return [n for n in cursor.execute('SELECT * FROM news')]

#Удаление новости через админку
